...
public class Main {
	public static void main(String[] args) {
	 ...
	 // Ruslans tests 
		...
		*/
		String exptest4 = "9+24/(7-3)";
		double expresult4 =15.0;
		double b = Q3.calc(exptest4);
		System.out.print(Q3.calc(exptest4));
		/*
		if(Q3.calc(exptest3) != expresult3)			
			//System.out.print("\nProblem with:" + exptest3);
		else
			System.out.print(Q3.calc(exptest3));
		
		String exptest4 = "3+5*4-12";
		double expresult4 =11.0;
		if(Q3.calc(exptest4) != expresult4)			
			System.out.print("\nProblem with:" + exptest4);
		
		String exptest5 = "7.5*(4.3+(6-12.3))/(0-3.0)";
		double expresult5 =5.002;
